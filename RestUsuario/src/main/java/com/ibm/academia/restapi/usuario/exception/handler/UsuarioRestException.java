package com.ibm.academia.restapi.usuario.exception.handler;
...
import com.ibm.academia.restapi.usuario.exception.NotFoundException;




@ControllerAdvice
public class UsuarioRestException {
